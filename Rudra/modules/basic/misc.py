...
from Rudra import START_TIME
from Rudra import SUDO_USER
from Rudra.helper.PyroHelpers import ReplyCheck
from Rudra.modules.help import add_command_help
from Rudra.modules.bot.inline import get_readable_time
...
if ALIVE_TEXT:
   txt = ALIVE_TEXT
    ...
    txt = (
        ...
        f"├• **ѕυρρσят**: [Click](t.me/SOFIA_VC_BOTS)\n"
        f"├• **¢нαииєℓ**: [Click](t.me/SOFIA_TG_BOTS)"
...
async def repo(bot: Client, message: Message):
    ...
    await asyncio.sleep(1)
    await message.edit("Here is repo: \n\n\nhttps://t.me/SOFIA_TG_BOTS\nFork & Give an ⭐")


@Client.on_message(filters.command("creator", ".") & filters.me)
async def creator(bot: Client, message: Message):
    await message.edit("https://t.me/rudra_jaat")
